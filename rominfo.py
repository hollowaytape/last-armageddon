...
SEGMENTS = [
    ...
    #PointerSegment(0x4a181c2, 0x4a181da, 'PartyNamesPointers'),
    Segment(0x4a181e6, 0x4a18236, 'PartyNames'),
    #PointerSegment(0x4a18236, 0x4a182a6, 'SkillsPointers'),
    Segment(0x4a182a6, 0x4a184d4, 'Skills'),
    ...
    Segment(0x4a25700, 0x4a25743, 'Combat1'),
    Segment(0x4a27728, 0x4a27800, 'StatsMenu1'),
    Segment(0x4a27daf, 0x4a27e2b, 'CreationSystem'),
    Segment(0x4a46249, 0x4a46254, 'Jin2'),
    Segment(0x4a4817e, 0x4a48186, 'Combat2'),
    #PointerSegment(0x4a48186, 0x4a48196, 'CombatPointers'),
    ...
    #PointerSegment(0x4aea513, 0x4aea523, 'MenuPointers'),
    Segment(0x4aea523, 0x4aea54b, 'Menu'),
    #PointerSegment(0x4afab19, 0x4afab27, 'Submenu1Pointers'),
    Segment(0x4afab27, 0x4afab46, 'Submenu1'),
    Segment(0x4afb19b, 0x4afb240, 'Submenu2'),
    Segment(0x4afb5cd, 0x4afb5e0, 'SubmenuQuestions'),
    Segment(0x4afbc84, 0x4afbd30, 'Submenu3'),
    #PointerSegment(0x4afbcd9, 0x4afbceb, 'StatsMenu2Pointers'),
    Segment(0x4afbceb, 0x4afbd30, 'StatsMenu2'),
    Segment(0x4afc34b, 0x4afc39f, 'UseMenu'),
    Segment(0x4afc894, 0x4afc8c1, 'Jin3'),
    Segment(0x4afd2e8, 0x4afd31d, 'Jin4'),
    #PointerSegment(0x4a4a9ff, 0x4a4aa1d, 'EquipMenuPointers'),
    Segment(0x4afd9a6, 0x4afd9d5, 'EquipMenu'),
